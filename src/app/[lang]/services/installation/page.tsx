...
export async function generateMetadata({ params }: { params: Promise<{ lang: Locale }> }): Promise<Metadata> {
    ...
    return {
        title: `${translations.services.installation.title} | ${translations.common.companyName}`,
        description: translations.services.installation.description,
    };
}

export default async function InstallationPage({ params }: { params: Promise<{ lang: Locale }> }) {
    const { lang } = await params;
    const translations = await getTranslations(lang);
    const service = translations.services.installation;
    ...
    return (
        <MainLayout locale={lang} translations={translations}>
            ...
            <PageHero
                ...
                backgroundImage="/images/installation.jpg"
            />
