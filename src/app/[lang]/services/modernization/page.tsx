...
export async function generateMetadata({ params }: { params: Promise<{ lang: Locale }> }): Promise<Metadata> {
    ...
    return {
        title: `${translations.services.modernization.title} | ${translations.common.companyName}`,
        description: translations.services.modernization.description,
    };
}

export default async function ModernizationPage({ params }: { params: Promise<{ lang: Locale }> }) {
    const { lang } = await params;
    const translations = await getTranslations(lang);
    const service = translations.services.modernization;
    ...
    return (
        <MainLayout locale={lang} translations={translations}>
            ...
            <PageHero
                ...
                backgroundImage="/images/modernization.jpg"
            />
